...
@Configuration
@MapperScan(basePackages = { "com.example.one.dao.query"}, sqlSessionFactoryRef = "masterSqlSessionFactory")
...
//    }
    ...
    public SqlSessionFactory masterSqlSessionFactory(@Qualifier("master") DataSource dataSource) throws Exception {
        ...
        ResourcePatternResolver resolver = new PathMatchingResourcePatternResolver();
        try {
            bean.setMapperLocations(resolver.getResources("classpath*:mapper/query/*.xml"));
